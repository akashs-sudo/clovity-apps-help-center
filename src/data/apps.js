export const apps = [
  {
    ...
    rating: 4,
    installs: 189,
    icon: "/images/global/png/dashboard-charts-for-jira.png",
    description:
  ...
  },
  {
    ...
    rating: 4,
    installs: 149,
    icon: "/images/global/png/timesheet-&-ppm.png",
    description:
  ...
  },
  {
    ...
    rating: 4,
    installs: 169,
    icon: "/images/global/png/content-formatting.png",
    description:
  ...
  },
  {
    ...
    rating: 4,
    installs: 88,
    icon: "/images/global/png/custom-reports-for-confluence.png",
    description:
  ...
  },
  {
    ...
    rating: 4,
    installs: 74,
    icon: "/images/global/png/latex-uml-diagram.png",
    description:
  ...
  },
  {
    ...
    shortName: "Pulse AI for Jira",
    platform: "Jira Cloud",
    badge: null,
    rating: null,
    installs: 12,
    icon: "/images/global/png/pulse-ai.png",
    description:
      "AI-powered Jira instance health scoring, governance audits, sprint intelligence, and anomaly detection - all without leaving Jira.",
    marketplaceUrl:
